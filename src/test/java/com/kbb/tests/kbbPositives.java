...
public class kbbPositives {
	...
	public void tc_20() throws InterruptedException {
		...
		Assert.assertTrue(
				nexUrl.contains("https://www.kbb.com/bmw/2-series/?intent=buy-new&vehicleclass=newcar#zipo="));
		Thread.sleep(3000);
		driver.findElement(By.id("selectedZipCode")).sendKeys("20010");
		driver.findElement(By.id("enterzipsubmit")).click();
		BrowserUtils
				.findElementByCss("#Model-year-select > div.model-year-container.mod-content.y-2018 > div.right > a")
				.click();
		...
		BrowserUtils.waitForClickablility(By.cssSelector(
				"#Content > div.mod-gradiated-content.styles.trade-sell > section > div.mod-single > div.mod-category.category-2.last > div > a"),
				5000).click();
		Assert.assertTrue(
				driver.getTitle().contains("2018 BMW 2 Series Styles and Equipment, New Cars | Kelley Blue Book"));
		// click on select this style
		BrowserUtils.waitForClickablility(
				By.cssSelector("div.vehicle-styles-container:nth-child(3) > div:nth-child(1) > a:nth-child(3)"), 30)
				.click();

		String stdOptnBt = BrowserUtils.findElementByCss("#Options-container > p.section-subtitle > a").getText();
		String colorAndInterior = BrowserUtils
				.findElementByCss(
						"#Options-container > div:nth-child(2) > div.accordion.mod-head.expandable > span.mod-title")
				.getText();
		String pwrTrain = BrowserUtils
				.findElementByCss(
						"#Options-container > div:nth-child(3) > div.accordion.mod-head.expandable > span.mod-title")
				.getText();
		String packages = BrowserUtils
				.findElementByCss(
						"#Options-container > div:nth-child(4) > div.accordion.mod-head.expandable > span.mod-title")
				.getText();
		String optns = BrowserUtils
				.findElementByCss(
						"#Options-container > div:nth-child(5) > div.accordion.mod-head.expandable > span.mod-title")
				.getText();
		String feesAndIncentives = BrowserUtils
				.findElementByCss(
						"#Options-container > div:nth-child(6) > div.accordion.mod-head.expandable > span.mod-title")
				.getText();
		...
		// click on compare
		BrowserUtils.findElementByCss(
				"#pageBottom > div.container-18.nct.medium.js-push-right > div.grid-3.nav-wrap.aside > ul > li:nth-child(2) > a")
				.click();
		String fe = BrowserUtils.findElementByCss(
				"#pageBottom > div.container-18.nct.medium.js-push-right > section > div.mod-inv.vehicle-scorecard > div.mod-content > div.left-column > ul > li:nth-child(1) > a")
				.getText();
		String hp = BrowserUtils.findElementByCss(
				"#pageBottom > div.container-18.nct.medium.js-push-right > section > div.mod-inv.vehicle-scorecard > div.mod-content > div.left-column > ul > li:nth-child(2) > a")
				.getText();
		String fiveYear = BrowserUtils.findElementByCss(
				"#pageBottom > div.container-18.nct.medium.js-push-right > section > div.mod-inv.vehicle-scorecard > div.mod-content > div.left-column > ul > li:nth-child(3) > a")
				.getText();
		String cr = BrowserUtils.findElementByCss(
				"#pageBottom > div.container-18.nct.medium.js-push-right > section > div.mod-inv.vehicle-scorecard > div.mod-content > div.left-column > ul > li:nth-child(4) > a")
				.getText();
		String msrp = BrowserUtils.findElementByCss(
				"#pageBottom > div.container-18.nct.medium.js-push-right > section > div.mod-inv.vehicle-scorecard > div.mod-content > div.left-column > ul > li:nth-child(5) > a")
				.getText();
	...
	public void tc_22() throws InterruptedException {
		...
		BrowserUtils
				.waitForClickablility(By.cssSelector(
						"#Model-year-select > div.model-year-container.mod-content.y-2018 > div.right > a"), 30)
				.click();
		String expectedTitle2 = "2018 Acura MDX Styles and Equipment, New Cars | Kelley Blue Book";
		Assert.assertTrue(driver.getTitle().contains(expectedTitle2));
		// click on select this base style
		BrowserUtils.waitForClickablility(By.cssSelector(
				"#Styles-list-container > div > div > div.vehicle-styles-container.clear.row-white.first > div.vehicle-styles-head.accordion-sub.expandable > a"),
				30).click();
	...
	public void tc_23() throws InterruptedException {
		...
		String nexUrl = driver.getCurrentUrl();
		Assert.assertTrue(
				nexUrl.contains("https://www.kbb.com/bmw/3-series/?intent=buy-new&vehicleclass=newcar#zipo="));
		Thread.sleep(3000);
		driver.findElement(By.id("selectedZipCode")).sendKeys("20010");
		driver.findElement(By.id("enterzipsubmit")).click();
		BrowserUtils
				.findElementByCss("#Model-year-select > div.model-year-container.mod-content.y-2017 > div.right > a")
				.click();
		String expectedTitle2 = "2017 BMW 3 Series - Select A Category | Kelley Blue Book";
		Assert.assertTrue(driver.getTitle().contains(expectedTitle2));
		// click on sedan
		BrowserUtils.waitForClickablility(By.cssSelector(
				"#Content > div.mod-gradiated-content.styles.trade-sell > section > div.mod-single > div:nth-child(2) > div > a"),
				5000).click();
		Assert.assertTrue(
				driver.getTitle().contains("2017 BMW 3 Series Styles and Equipment, New Cars | Kelley Blue Book"));
		// click on select this style
		BrowserUtils.waitForClickablility(By.cssSelector(
				"#Styles-list-container > div.style-category-container > div > div.vehicle-styles-container.clear.row-white.first > div.vehicle-styles-head.accordion-sub.expandable > a"),
				30).click();
	...
	public void tc_24() throws InterruptedException {
		...
		String nexUrl = driver.getCurrentUrl();
		Assert.assertTrue(
				nexUrl.contains("https://www.kbb.com/dodge/charger/?intent=buy-new&vehicleclass=newcar#zipo="));
		Thread.sleep(3000);
		driver.findElement(By.id("selectedZipCode")).sendKeys("20010");
		driver.findElement(By.id("enterzipsubmit")).click();
		BrowserUtils
		...
		BrowserUtils.waitForClickablility(By.cssSelector(
				...
				5000).click();
		Assert.assertTrue(
				driver.getTitle().contains("2018 Dodge Charger Styles and Equipment, New Cars | Kelley Blue Book"));
		// click on select this style
		BrowserUtils.waitForClickablility(
				By.cssSelector("div.vehicle-styles-container:nth-child(3) > div:nth-child(1) > a:nth-child(3)"), 30)
				.click();
